...
def greet():
  ...
  print("We'll help you find the shortest route between the following Vancouver landmarks: " + landmark_string)
...
def set_start_and_end(start_point, end_point):
  if start_point != None: #is not None
    change_input = input("What would you like to change? You can enter 'o' for 'origin', 'd' for 'destination', or 'b' for 'both': ")
    if change_point == "b":
